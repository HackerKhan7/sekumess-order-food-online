<html>
  ...
  <head>
    <title> Manager Signup | Seku Mess' </title>
  </head>
   ...
   <p>create new manager</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"> Create new manager Account </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> username Reg No.: </label>
            <div class="input-group">
              <input class="form-control" id="username" type="text" name="username" placeholder="Enter Reg No." required="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
            </span>
              </span>
  ...
  <br>
  <p> Food Designers 2020 | &copy All Rights Reserved </p>
  <br>
  </footer>
</html>