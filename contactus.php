...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Seku Mess' </span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="color:green; margin-bottom: 25px; text-align: center; font-size: 30px;"> Contact Form</h3>
          ...
          <div class="form-group">
           <textarea class="form-control" type="textarea" id="message" name="message" placeholder="Message" maxlength="100" rows="6"></textarea>
...
$mailTo = "Williammusyoka09@gmail.com";
