<html>
<head>
    <title> Seku Student Signup | Seku Mess' </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi<span class="edit"> Seku Student' </span> , <br> Welcome to <span class="edit"> Seku Mess' </span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Username as Reg No.: </label>
            <div class="input-group">
              <input class="form-control" id="username" type="text" name="username" placeholder="Your registration number" required="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
            </span>
              </span>
