...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1 style="green">Your Orders</h1>
        <p>Oops! We can't smell your delicious meal here. Go back and <a href="foodlist.php">RETURN  to order now.</a></p>
